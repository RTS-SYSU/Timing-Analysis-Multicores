...
entry:
  ...
  %1 = call i32 @llvm.ctlz.i32(i32 %0, i1 false), !dbg !1501
  %2 = load i32, i32* %n.addr, align 4, !dbg !1502
  %3 = call i32 @llvm.ctlz.i32(i32 %2, i1 false), !dbg !1503
  %sub = sub nsw i32 %1, %3, !dbg !1504
  store i32 %sub, i32* %sr, align 4, !dbg !1505
  %4 = load i32, i32* %sr, align 4, !dbg !1
  %inc = add i32 %4, 1, !dbg !23
  store i32 %inc, i32* %sr, align 4, !dbg !23
  %5 = load i32, i32* %n.addr, align 4, !dbg !24
  %6 = load i32, i32* %sr, align 4, !dbg !25
  %sub1 = sub i32 32, %6, !dbg !26
  %shl = shl i32 %5, %sub1, !dbg !27
  store i32 %shl, i32* %q, align 4, !dbg !28
  %7 = load i32, i32* %n.addr, align 4, !dbg !29
  %8 = load i32, i32* %sr, align 4, !dbg !30
  %shr = lshr i32 %7, %8, !dbg !31
  store i32 %shr, i32* %r, align 4, !dbg !32
  store i32 0, i32* %carry, align 4, !dbg !33
  br label %for.cond, !dbg !34

for.cond:                                         ; preds = %for.inc, %entry
  %9 = load i32, i32* %sr, align 4, !dbg !35
  %cmp = icmp ugt i32 %9, 0, !dbg !36
  br i1 %cmp, label %for.body, label %for.end, !dbg !34

for.body:                                         ; preds = %for.cond
  %10 = load i32, i32* %r, align 4, !dbg !37
  %shl2 = shl i32 %10, 1, !dbg !38
  %11 = load i32, i32* %q, align 4, !dbg !39
  %shr3 = lshr i32 %11, 31, !dbg !40
  %or = or i32 %shl2, %shr3, !dbg !41
  store i32 %or, i32* %r, align 4, !dbg !42
  %12 = load i32, i32* %q, align 4, !dbg !43
  %shl4 = shl i32 %12, 1, !dbg !44
  %13 = load i32, i32* %carry, align 4, !dbg !45
  %or5 = or i32 %shl4, %13, !dbg !46
  store i32 %or5, i32* %q, align 4, !dbg !47
  %14 = load i32, i32* %d.addr, align 4, !dbg !48
  %15 = load i32, i32* %r, align 4, !dbg !49
  %sub6 = sub i32 %14, %15, !dbg !50
  %sub7 = sub i32 %sub6, 1, !dbg !51
  %shr8 = ashr i32 %sub7, 31, !dbg !52
  store i32 %shr8, i32* %s, align 4, !dbg !53
  %16 = load i32, i32* %s, align 4, !dbg !54
  %and = and i32 %16, 1, !dbg !55
  store i32 %and, i32* %carry, align 4, !dbg !56
  %17 = load i32, i32* %d.addr, align 4, !dbg !57
  %18 = load i32, i32* %s, align 4, !dbg !58
  %and9 = and i32 %17, %18, !dbg !59
  %19 = load i32, i32* %r, align 4, !dbg !60
  %sub10 = sub i32 %19, %and9, !dbg !60
  store i32 %sub10, i32* %r, align 4, !dbg !60
  br label %for.inc, !dbg !61

for.inc:                                          ; preds = %for.body
  %20 = load i32, i32* %sr, align 4, !dbg !62
  %dec = add i32 %20, -1, !dbg !62
  store i32 %dec, i32* %sr, align 4, !dbg !62
  br label %for.cond, !dbg !34, !llvm.loop !63

for.end:                                          ; preds = %for.cond
  %21 = load i32, i32* %q, align 4, !dbg !65
  %shl11 = shl i32 %21, 1, !dbg !66
  %22 = load i32, i32* %carry, align 4, !dbg !67
  %or12 = or i32 %shl11, %22, !dbg !68
  store i32 %or12, i32* %q, align 4, !dbg !69
  %23 = load i32, i32* %q, align 4, !dbg !70
  ret i32 %23, !dbg !71
}
