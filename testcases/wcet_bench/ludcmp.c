/* MDH WCET BENCHMARK SUITE. File version $Id: ludcmp.c,v 1.2 2006/01/27
 * 13:15:28 jgn Exp $ */
...
double a_a[50][50], b[50], x[50];

int ludcmp_ludcmp(/* int nmax, */ int n, double eps);
...
int ludcmp_main(void) {
  ...
  chkerr = ludcmp_ludcmp(/* nmax, */ n, eps);
