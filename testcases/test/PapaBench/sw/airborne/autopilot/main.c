...
double pp_sin(double x) {
  ...
  xi = x;
  sign = 1;
  _Pragma("loopbound min 0 max 0") while (xi < -1.57079632679489661923) xi +=
      6.28318530717958647692;
  _Pragma("loopbound min 0 max 0") while (xi > 4.71238898038468985769) xi -=
      6.28318530717958647692;
  ...
  q = xi / 1.57079632679;
  q2 = q * q;
  y = ((((.00015148419 * q2 - .00467376557) * q2 + .07968967928) * q2 -
        .64596371106) *
           q2 +
       1.57079631847) *
      q;
