...
if stat_data:
    ...
    print(f"- Analysed interference matrix: {output_stat_inter_csv}")
    print(f"- Analysed total WCET matrix: {output_stat_total_csv}")

print("Statistics completed, results have been saved to:")
print(f"- RWInfo summary: {output_md}")
print(f"- Execution interference matrix: {output_interference_csv}")
print(f"- Execution total WCET matrix: {output_total_csv}")
print(f"- Single-core time matrix: {output_intra_csv}")
